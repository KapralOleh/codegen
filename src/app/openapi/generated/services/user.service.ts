...
export class UserService extends BaseService {
  ...
  createUser$Json$Json(params?: {
    ...
    return this.createUser$Json$Json$Response(params).pipe(
  ...
  createUser$Json$Xml(params?: {
    ...
    return this.createUser$Json$Xml$Response(params).pipe(
      map((r: StrictHttpResponse<User>) => r.body as User)
    );
  }
  ...
  createUser$Xml$Json(params?: {
    ...
    return this.createUser$Xml$Json$Response(params).pipe(
      map((r: StrictHttpResponse<User>) => r.body as User)
    );
  }
  ...
  createUser$XWwwFormUrlencoded$Json(params?: {
    ...
    return this.createUser$XWwwFormUrlencoded$Json$Response(params).pipe(
      map((r: StrictHttpResponse<User>) => r.body as User)
    );
  }
  ...
  createUsersWithListInput$Json(params?: {
    ...
    return this.createUsersWithListInput$Json$Response(params).pipe(
      map((r: StrictHttpResponse<User>) => r.body as User)
    );
  }
